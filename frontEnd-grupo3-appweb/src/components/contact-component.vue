...
<template>
  ...
  <div class="form-container">
    <div class="control">
      ...
      <pv-inputText class="text" type="text" id="name" size="small" aria-label="Enter your name"/>
    </div>
    <div class="control">
      <pv-label class="label" for="email" >Email:</pv-label>
      <pv-inputText class="text" type="email" id="email" size="small" aria-label="Enter your email"/>
    </div>
    <div class="control">
      <pv-label class="label" for="message">Message:</pv-label>
      <pv-inputText class="text" type="text" id="text" size="large" aria-label="Enter your message"/>
    </div>
